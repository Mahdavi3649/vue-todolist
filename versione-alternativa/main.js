...
ATTENZIONE: Eventuali tickets su questa versione verranno gestiti solo se non ce ne sono altri in attesa per la versione ufficiale e solo se avete giá fatto la versione ufficiale completa di bonus. */
...
const app = new Vue({
    ...
    methods: {
        ...
        removeTask(index){
            ...
            this.trashed.push(this.tasks[index])
        ...
        emptyBinTasks(){
            this.trashed.splice(0, this.trashed.length)
        },
        emptyTasks(index){
